...
public class ABCRunner {
	...
	int nsamps=1000;
        ...
        double[] thresholds={6, 5, 4, 3.5, 3.25, 3,2.75, 2.5, 2.25, 2.125, 2, 1.875, 1.75, 1.625, 1.5, 1.375, 1.25, 1.125, 1, 0.875, 0.75};
	...
	public ABCRunner() {
		...
		//numReps=npc*np;
                ...
                Priors p=new Priors(random.nextLong());
                double[] x=p.sampleFromPriors();
                cemp=new ChaffinchABC[numpops];
                for (int i=0; i<numpops; i++){
                    cemp[i]=new ChaffinchABC(fileLocation[i], x, p.variables, System.currentTimeMillis());
                }
